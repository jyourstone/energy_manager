...
| Battery commanded charge limit *(diagnostic)* | Charge power limit EM sends to the battery (tracks live PV surplus — PV minus house consumption — during solar charging; the would-be value in observe-only mode) |
